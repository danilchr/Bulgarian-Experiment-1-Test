...
Sequence(  "intro", "intro1",  "demo",  "demo1",  "demo2", sepWith("sendAsync", randomize("experiment")), "sendAsync", SendResults(), "bye") 
...
///InitiateRecorder("http://sabotin.ung.si/~dk0035/tests", "Моля, регулирайте настройките на своя браузър, за да разрешите достъп до микрофона. След това натиснете връзката по-долу.")
    .label("intro")
...
newTrial("intro1", 
	...
	newText("Вашата задача е да изслушате незавършени изречения, след това да ги довършите, като произнсете само последната дума. Докато произнасяте изреченията, ще трябва да запишете гласа си, като използвате микрофона на компютъра си. За да запишете отговора си, кликнете върху бутон „Record“ (Запис). За да спрете записа, натиснете върху бутона „Stop“ (Стоп).")
	.css("width","40em")
	.css("line-height","1.4")
	//.css("padding-top","40px")
	.css("padding-bottom","20px")
...
newTrial("demo1", 
 ...
 newText("Пример 1:")
    ...
    newAudio("target", "Test/mono/test1_mono.wav")
         .play()
         .wait()
    ,
    newTimer("wait", 500)
...
newTrial("demo2", 
 ...
 newText("Пример 2:")
    ...
    newAudio("target", "Test/mono/test2_mono.wav")
         .play()
         .wait()
    ,
    newTimer("wait", 500)
